    ...
    pub fn paint(
        ...
        for line_idx in 0..num_lines {
            ...
            for (col_idx, cell) in cells {
                ...
                // Skip spaces to save draw calls
                if ch == ' ' {
                    continue;
                }
        ...
        // Paint cursor (only if visible in the current viewport scroll position)
        ...
        // Paint scrollbar indicator when there is scrollback history
